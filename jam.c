...
{
    unsigned char n[81],d[81],s[161],s1[81],s2[81],s3[81],ch;
...
void scanj(int msgnum,int *nextsub,int sb, int private)
{
    ...
    char s[161],*b,*ss1,s1[81],findtitle[81];
    hdrinfo hdr;
...
{
    char s[LEN],s1[LEN],s2[LEN],ro[81],fnx[81],chx,*ss,*ss1,*p;
...
void quote_jam(char *buf,long len,hdrinfo *hdr)
{
    char *nb, word[81],thisline[81],from[81];
    long pos=0,nlen=0;
