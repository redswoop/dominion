...
{
    char ch1;
    char *ss, *ss1,s[81],cmd[128],txt[10],tx[12];
    int f,l,i,type,i1;
...
void tleft(int dot)
{
    int cx,cy,ctl,cc,i;
    double nsln;
    char tl[80],s[81],*p,arg[30],oarg[30],oattr;
    FILE *f;
    int x,y,attr,type;
...
void topscreen(void)
{
    ...
    char ar[17],dar[17],restrict[17],rst[17],lo[6],s[81],*b,*p;
    ...
    close(i);
    memmove(&screen[0],b,linelen*160);
    farfree(b);
